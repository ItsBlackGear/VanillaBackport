...
public class WaypointStyleProvider implements DataProvider {
    ...
    private static void bootstrap(BiConsumer<ResourceKey<WaypointStyleAsset>, WaypointStyle> consumer) {
        consumer.accept(
            ...
            new WaypointStyle(
                ...
                332,
                List.of(
                    new ResourceLocation("default_0"),
                    new ResourceLocation("default_1"),
                    new ResourceLocation("default_2"),
                    new ResourceLocation("default_3")
                )
            )
        );
        consumer.accept(
        ...
        consumer.accept(
            ...
            new WaypointStyle(
                ...
                332,
                List.of(
                    new ResourceLocation("lodestone_0"),
                    new ResourceLocation("lodestone_1"),
                    new ResourceLocation("lodestone_2")
                )
            )
        );
        consumer.accept(
            ...
            new WaypointStyle(
                ...
                332,
                List.of(
                    new ResourceLocation("death_0"),
                    new ResourceLocation("death_1"),
                    new ResourceLocation("death_2")
                )
            )
        );
        consumer.accept(
    ...
    private static <T, E> CompletableFuture<?> save(CachedOutput cache, Codec<E> codec, Function<T, Path> pathGetter, Map<T, E> contents) {
        return save(cache, e -> codec.encodeStart(JsonOps.INSTANCE, e).getOrThrow(false, IllegalStateException::new), pathGetter, contents);
    }
