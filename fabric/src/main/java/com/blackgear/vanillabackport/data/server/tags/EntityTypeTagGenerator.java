...
import com.blackgear.vanillabackport.core.data.tags.create.SableEntityTags;
...
public class EntityTypeTagGenerator extends FabricTagProvider.EntityTypeTagProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.getOrCreateTagBuilder(SableEntityTags.RETAIN_IN_SUB_LEVEL)
            .add(ModEntityTypes.CUSHION.get());
