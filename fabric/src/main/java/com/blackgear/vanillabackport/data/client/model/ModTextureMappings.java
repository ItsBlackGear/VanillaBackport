...
public class ModTextureMappings {
    ...
    public static TextureMapping driedGhast(String string) {
        return new TextureMapping()
            ...
            .put(ModTextureSlots.TENTACLES, TextureMapping.getBlockTexture(ModBlocks.DRIED_GHAST.get(), string + "_tentacles"));
    }
    
    public static TextureMapping bars(Block block) {
        return new TextureMapping()
            .put(ModTextureSlots.BARS, TextureMapping.getBlockTexture(block))
