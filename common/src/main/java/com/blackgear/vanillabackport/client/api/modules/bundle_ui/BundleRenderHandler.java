...
public final class BundleRenderHandler {
    private static final ResourceLocation DEFAULT_BACK = new ResourceLocation("textures/item/bundle_open_back.png");
    private static final ResourceLocation DEFAULT_FRONT = new ResourceLocation("textures/item/bundle_open_front.png");
    ...
    static {
        for (DyeColor color : DyeColor.values()) {
            BACK_TEXTURES.put(color, new ResourceLocation("textures/item/" + color.getName() + "_bundle_open_back.png"));
            FRONT_TEXTURES.put(color, new ResourceLocation("textures/item/" + color.getName() + "_bundle_open_front.png"));
        }
    }
