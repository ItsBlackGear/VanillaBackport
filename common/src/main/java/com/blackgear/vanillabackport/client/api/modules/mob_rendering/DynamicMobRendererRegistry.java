...
public class DynamicMobRendererRegistry {
    ...
    public static <R extends LivingEntityRenderer<T, M>, T extends LivingEntity, M extends EntityModel<T>> void register(Class<R> rendererClass, Function<EntityRendererProvider.Context, SpecialMobRenderer<T, M>> factory) {
        REGISTRY.put(rendererClass, (Function) factory);
    }
