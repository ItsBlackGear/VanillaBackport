...
public class SulfurCubeInnerLayer extends RenderLayer<SulfurCube, SulfurCubeModel> {
    ...
    private static final ResourceLocation SULFUR_CUBE_INNER_SMALL_LOCATION = new ResourceLocation("textures/entity/sulfur_cube/sulfur_cube_inner_small.png");
    ...
    public void render(
        ...
        if (!containedBlock.isEmpty()) {
            ...
            model.renderToBuffer(pose, buffer.getBuffer(renderType), packedLight, overlayCoords, 1.0F, 1.0F, 1.0F, 1.0F);
        }
    }
