...
public class PigSpecialRenderer extends AbstractVariantRenderer<Pig, PigModel<Pig>, PigVariant, PigVariant.ModelType> {
    public PigSpecialRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
