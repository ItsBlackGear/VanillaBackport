...
public class PigVariantlRenderer extends AbstractVariantRenderer<Pig, PigModel<Pig>, PigVariant, PigVariant.ModelType> {
    public PigVariantlRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
