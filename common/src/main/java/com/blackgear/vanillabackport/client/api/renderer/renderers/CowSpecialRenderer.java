...
public class CowSpecialRenderer extends AbstractVariantRenderer<Cow, CowModel<Cow>, CowVariant, CowVariant.ModelType> {
    public CowSpecialRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
