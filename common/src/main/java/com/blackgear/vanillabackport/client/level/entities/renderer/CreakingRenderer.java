...
public class CreakingRenderer<T extends Creaking> extends MobRenderer<T, CreakingModel<T>> {
    private static final ResourceLocation TEXTURE_LOCATION = VanillaBackport.resource("textures/entity/creaking/creaking.png");
    private static final ResourceLocation EYES_TEXTURE_LOCATION = VanillaBackport.resource("textures/entity/creaking/creaking_eyes.png");
