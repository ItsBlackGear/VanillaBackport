...
public class NowPlayingToast implements Toast, ToastModifier {
    ...
    private static final ResourceLocation MUSIC_NOTES_SPRITE = ResourceLocation.withDefaultNamespace("icon/music_notes");
    ...
    public static void renderToast(GuiGraphics graphics, Font font) {
        ...
        graphics.blitSprite(NOW_PLAYING_BACKGROUND_SPRITE, 0, 0, getWidth(currentSong, font), 30);
        ...
        graphics.blitSprite(MUSIC_NOTES_SPRITE, 7, 7, 16, 16);
