...
public class CustomBoatItem extends Item {
    ...
    public CustomBoatItem(ResourceLocation type, boolean hasChest, Properties properties) {
        super(properties);
        this.type = type;
    ...
    private Boat getBoat(Level level, HitResult hitResult) {
        return this.hasChest
            ? new CustomChestBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z, this.type)
            : new CustomBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z, this.type);
    }
}