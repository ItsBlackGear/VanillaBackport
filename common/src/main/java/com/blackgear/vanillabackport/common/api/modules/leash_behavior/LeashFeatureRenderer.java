...
public class LeashFeatureRenderer<T extends Entity> {
    ...
    private void setupLeashRendering(T entity, float partialTicks) {
        ...
        if (leashHolder != null) {
            float entityRotation = Leashable.vb$getPreciseBodyRotation(entity, partialTicks) * Mth.DEG_TO_RAD;
            ...
            if (useQuadLeash) {
                float holderRotation = Leashable.vb$getPreciseBodyRotation(leashHolder, partialTicks) * Mth.DEG_TO_RAD;
