...
public abstract class AbstractCubeMob extends AgeableMob implements TravelAwareEntity {
    ...
    protected void dealDamage(LivingEntity target) {
        if (this.level() instanceof ServerLevel && this.isAlive() && this.isWithinMeleeAttackRange(target) && this.hasLineOfSight(target)) {
    ...
    public EntityDimensions getDimensions(Pose pose) {
        float modifier = this.isBaby() ? 2.0F : 1.0F;
        return super.getDimensions(pose).scale(modifier * this.getSize());
    }
    ...
    protected static class CubeMobAttackGoal extends Goal {
        ...
        public CubeMobAttackGoal(AbstractCubeMob cube) {
            this.cube = cube;
        ...
        public boolean canUse() {
            LivingEntity target = this.cube.getTarget();
            if (target == null) {
                return false;
            } else {
                return this.cube.canAttack(target) && this.cube.getMoveControl() instanceof CubeMobMoveControl;
            }
        }
        ...
        public boolean canContinueToUse() {
            ...
            if (target == null) {
                ...
                return this.cube.canAttack(target) && --this.growTiredTimer > 0;
            }
        }
        ...
        public void tick() {
            LivingEntity target = this.cube.getTarget();
            if (target != null) {
                this.cube.lookAt(target, 10.0F, 10.0F);
            }

            if (this.cube.getMoveControl() instanceof CubeMobMoveControl<?> control) {
                control.setDirection(this.cube.getYRot(), this.cube.isDealsDamage());
            }
        }
    }
    ...
    private static class CubeMobFloatGoal extends Goal {
        ...
        @Override
        public boolean canUse() {
            return EntityUtils.isInLiquid(this.cube) && this.cube.getMoveControl() instanceof CubeMobMoveControl;
        }
    ...
    private static class CubeMobRandomDirectionGoal extends Goal {
        ...
        public boolean canUse() {
            return this.cube.getTarget() == null
                && (this.cube.onGround() || EntityUtils.isInLiquid(this.cube) || this.cube.hasEffect(MobEffects.LEVITATION))
