...
public class ChaosCubedPlacements {
    ...
    public static final ResourceKey<PlacedFeature> SULFUR_POOL = REGISTRIES.register("sulfur_pool",
        ChaosCubedFeatures.SULFUR_POOL,
        ...
        BiomeFilter.biome());
    public static final ResourceKey<PlacedFeature> ROOTED_SULFUR_SPRING = REGISTRIES.register("rooted_sulfur_spring",
        ChaosCubedFeatures.ROOTED_SULFUR_SPRING,
        ...
        RandomOffsetPlacement.vertical(ConstantInt.of(-1)),
        BiomeFilter.biome());
    public static final ResourceKey<PlacedFeature> SULFUR_SPIKE_CLUSTER = REGISTRIES.register("sulfur_spike_cluster",
        ChaosCubedFeatures.SULFUR_SPIKE_CLUSTER,
        CountPlacement.of(UniformInt.of(48, 96)),
        InSquarePlacement.spread(),
        PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT,
        BiomeFilter.biome());
    public static final ResourceKey<PlacedFeature> SULFUR_SPIKE = REGISTRIES.register("sulfur_spike",
        ChaosCubedFeatures.SULFUR_SPIKE,
