package com.blackgear.vanillabackport.common.level.entity.mob.monster.sulfurcube;
    ...
    public record AttributeEntry(Holder<Attribute> attribute, AttributeModifier modifier) {
        ...
        public static AttributeEntry add(Holder<Attribute> attribute, double amount, ResourceKey<SulfurCubeArchetype> archetype) {
            ...
            return new AttributeEntry(
                ...
                new AttributeModifier(
                    ResourceLocation.withDefaultNamespace(archetype.location().getPath() + "_add_" + attributeLocation.getNamespace() + "_" + attributeLocation.getPath()),
                    amount,
        ...
        public static AttributeEntry multiply(Holder<Attribute> attribute, double amount, ResourceKey<SulfurCubeArchetype> archetype) {
            ...
            return new AttributeEntry(
                attribute,
                new AttributeModifier(
                    ResourceLocation.withDefaultNamespace(archetype.location().getPath() + "_mul_" + attributeLocation.getNamespace() + "_" + attributeLocation.getPath()),
                    amount - 1.0,
