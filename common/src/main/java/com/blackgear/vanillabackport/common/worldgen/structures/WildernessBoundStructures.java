...
public class WildernessBoundStructures {
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_BAMBOO_JUNGLE = REGISTRIES.register("abandoned_camp_bamboo_jungle", context -> {
        ...
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_BAMBOO_JUNGLE), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_BIRCH_FOREST = REGISTRIES.register("abandoned_camp_birch_forest", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_BIRCH_FOREST), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_CHERRY_GROVE = REGISTRIES.register("abandoned_camp_cherry_grove", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_CHERRY_GROVE), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_DAPPLED_FOREST = REGISTRIES.register("abandoned_camp_dappled_forest", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_DAPPLED_FOREST), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_FLOWER_FOREST = REGISTRIES.register("abandoned_camp_flower_forest", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_FLOWER_FOREST), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_FOREST = REGISTRIES.register("abandoned_camp_forest", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_FOREST), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_MEADOW = REGISTRIES.register("abandoned_camp_meadow", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_MEADOW), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_OLD_GROWTH_BIRCH_FOREST = REGISTRIES.register("abandoned_camp_old_growth_birch_forest", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_OLD_GROWTH_BIRCH_FOREST), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_OLD_GROWTH_PINE_TAIGA = REGISTRIES.register("abandoned_camp_old_growth_pine_taiga", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_OLD_GROWTH_PINE_TAIGA), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_OLD_GROWTH_SPRUCE_TAIGA = REGISTRIES.register("abandoned_camp_old_growth_spruce_taiga", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_OLD_GROWTH_SPRUCE_TAIGA), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_PALE_GARDEN = REGISTRIES.register("abandoned_camp_pale_garden", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_PALE_GARDEN), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_SAVANNA = REGISTRIES.register("abandoned_camp_savanna", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_SAVANNA), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_SNOWY_TAIGA = REGISTRIES.register("abandoned_camp_snowy_taiga", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_SNOWY_TAIGA), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_SPARSE_JUNGLE = REGISTRIES.register("abandoned_camp_sparse_jungle", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_SPARSE_JUNGLE), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_SWAMP = REGISTRIES.register("abandoned_camp_swamp", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_SWAMP), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_TAIGA = REGISTRIES.register("abandoned_camp_taiga", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_TAIGA), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_WINDSWEPT_FOREST = REGISTRIES.register("abandoned_camp_windswept_forest", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_WINDSWEPT_FOREST), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
    ...
    public static final ResourceKey<Structure> ABANDONED_CAMP_WOODED_BADLANDS = REGISTRIES.register("abandoned_camp_wooded_badlands", context -> {
        ...
        HolderGetter<StructureTemplatePool> templates = context.lookup(Registries.TEMPLATE_POOL);
        return new JigsawStructure(
            new Structure.StructureSettings(biomes.getOrThrow(ModBiomeTags.HAS_ABANDONED_CAMP_WOODED_BADLANDS), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, TerrainAdjustment.BEARD_THIN),
