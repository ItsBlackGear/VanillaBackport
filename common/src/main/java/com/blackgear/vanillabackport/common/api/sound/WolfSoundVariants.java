package com.blackgear.vanillabackport.common.api.sound;
...
public class WolfSoundVariants {
    public static final BuiltInCoreRegistry<WolfSoundVariant> REGISTRIES = new BuiltInCoreRegistry<>(ModRegistries.WOLF_SOUND_VARIANT.get(), VanillaBackport.NAMESPACE);
    ...
    private static ResourceKey<WolfSoundVariant> register(SoundSet soundSet, SoundEvent ambient, SoundEvent death, SoundEvent growl, SoundEvent hurt, SoundEvent pant, SoundEvent whine) {
        return REGISTRIES.resource(soundSet.getIdentifier(), new WolfSoundVariant(ambient, death, growl, hurt, pant, whine));
    }
