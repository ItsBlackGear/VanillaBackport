...
public class WaypointCommand {
    ...
    private static int setWaypointColor(CommandSourceStack source, WaypointTransmitter waypoint, Integer color) {
        ...
        MutableComponent hexColor = Component.literal(HexFormat.of().withUpperCase().toHexDigits(ColorUtils.color(0, color), 6));
        source.sendSuccess(() -> Component.translatable("commands.waypoint.modify.color", hexColor.setStyle(hexColor.getStyle().withColor(color))), false);
        return 0;
    }
