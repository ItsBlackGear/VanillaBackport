...
public class CowVariants {
    public static final BuiltInCoreRegistry<CowVariant> REGISTRIES = BuiltInCoreRegistry.create(ModRegistries.COW_VARIANT.get(), VanillaBackport.NAMESPACE);
    
    public static final ResourceKey<CowVariant> TEMPERATE = register("temperate",
        CowVariant.ModelType.NORMAL,
        "cow",
        SpawnPrioritySelectors.fallback(0));
    public static final ResourceKey<CowVariant> WARM = register("warm",
        CowVariant.ModelType.WARM,
        "warm_cow",
        ModBiomeTags.SPAWNS_WARM_VARIANT_FARM_ANIMALS);
    public static final ResourceKey<CowVariant> COLD = register("cold",
