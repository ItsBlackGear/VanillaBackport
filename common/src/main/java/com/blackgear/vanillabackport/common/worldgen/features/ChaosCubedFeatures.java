...
import com.blackgear.vanillabackport.common.level.blocks.PotentSulfurState;
                                ...
                                HolderSet.direct(
                                    ...
                                    sulfurSprings.apply(
                                        SimpleWeightedRandomList.<TemplateEntry>builder()
                                            .add(TemplateEntry.of(ResourceLocation.withDefaultNamespace("spring/sulfur_spring_small_1")), 1)
                                            .add(TemplateEntry.of(ResourceLocation.withDefaultNamespace("spring/sulfur_spring_small_2")), 1)
                                            .add(TemplateEntry.of(ResourceLocation.withDefaultNamespace("spring/sulfur_spring_small_3")), 1)
                                            .add(TemplateEntry.of(ResourceLocation.withDefaultNamespace("spring/sulfur_spring_small_4")), 1)
                                            .build()
                                    )
                                )
                            )
                        ...
                        PlacementUtils.inlinePlaced(
                            ...
                            new SimpleRandomFeatureConfiguration(
                                HolderSet.direct(
                                    ...
                                    sulfurSprings.apply(
                                        SimpleWeightedRandomList.<TemplateEntry>builder()
                                            .add(TemplateEntry.of(ResourceLocation.withDefaultNamespace("spring/sulfur_spring_medium_1")), 1)
                                            .add(TemplateEntry.of(ResourceLocation.withDefaultNamespace("spring/sulfur_spring_medium_2")), 1)
                                            .add(TemplateEntry.of(ResourceLocation.withDefaultNamespace("spring/sulfur_spring_medium_3")), 1)
                                            .build()
                                    )
                                )
                            )
                        ...
                        PlacementUtils.inlinePlaced(
                            ...
                            new SimpleRandomFeatureConfiguration(
                                HolderSet.direct(
                                    ...
                                    sulfurSprings.apply(
                                        SimpleWeightedRandomList.<TemplateEntry>builder()
                                            .add(TemplateEntry.of(ResourceLocation.withDefaultNamespace("spring/sulfur_spring_large_1")), 1)
                                            .add(TemplateEntry.of(ResourceLocation.withDefaultNamespace("spring/sulfur_spring_large_2")), 1)
                                            .build()
                                    )
                                )
                            )
                        ...
                        PlacementUtils.inlinePlaced(
                            ...
                            new SimpleRandomFeatureConfiguration(
                                HolderSet.direct(
                                    ...
                                    sulfurSprings.apply(
                                        SimpleWeightedRandomList.single(TemplateEntry.of(ResourceLocation.withDefaultNamespace("spring/sulfur_spring_extra_large_1")))
                                    )
                                )
                            )
                        ),
