...
public class SulfurCubeArchetypeReloadListener extends RegistryAwareJsonReloadListener {
    private static final Gson GSON = new GsonBuilder().setPrettyPrinting().disableHtmlEscaping().create();
    private static final String DIRECTORY = "sulfur_cube_archetype";

    public SulfurCubeArchetypeReloadListener() {
    ...
    public void parse(Map<ResourceLocation, JsonElement> resources, RegistryAccess registryAccess, ResourceManager manager, ProfilerFiller profiler) {
        ...
        for (Map.Entry<ResourceLocation, JsonElement> entry : resources.entrySet()) {
            ...
            try {
                ...
                VanillaBackport.LOGGER.error("Unexpected error processing archetype {}", name, exception);
            }
        }
