...
public class PigVariants {
    public static final BuiltInCoreRegistry<PigVariant> REGISTRIES = BuiltInCoreRegistry.create(ModRegistries.PIG_VARIANT.get(), VanillaBackport.NAMESPACE);

    public static final ResourceKey<PigVariant> TEMPERATE = register("temperate",
        PigVariant.ModelType.NORMAL,
        "pig",
        SpawnPrioritySelectors.fallback(0));
    public static final ResourceKey<PigVariant> WARM = register("warm",
        PigVariant.ModelType.NORMAL,
        "warm_pig",
        ModBiomeTags.SPAWNS_WARM_VARIANT_FARM_ANIMALS);
    public static final ResourceKey<PigVariant> COLD = register("cold",
