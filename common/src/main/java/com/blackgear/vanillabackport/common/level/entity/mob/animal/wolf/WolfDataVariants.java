...
public class WolfDataVariants {
    public static final BuiltInCoreRegistry<WolfDataVariant> REGISTRIES = BuiltInCoreRegistry.create(ModRegistries.WOLF_VARIANT.get(), VanillaBackport.NAMESPACE);
