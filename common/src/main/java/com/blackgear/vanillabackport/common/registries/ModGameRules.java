...
public class ModGameRules {
    public static final GameRules.Key<GameRules.BooleanValue> RULE_ENDER_PEARLS_VANISH_ON_DEATH = GameRulesAccessor.callRegister("enderPearlsVanishOnDeath",
        GameRules.Category.PLAYER,
        BooleanValueAccessor.callCreate(false, (server, value) -> {})
    );
