...
public class CatDataVariants {
    public static final BuiltInCoreRegistry<CatDataVariant> REGISTRIES = BuiltInCoreRegistry.create(new ResourceLocation("cat_variants"), VanillaBackport.NAMESPACE);
