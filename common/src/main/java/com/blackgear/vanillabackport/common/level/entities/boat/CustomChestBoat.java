...
public class CustomChestBoat extends ChestBoat implements CustomBoatBehavior {
    private static final EntityDataAccessor<String> BOAT_TYPE_ID = SynchedEntityData.defineId(CustomChestBoat.class, EntityDataSerializers.STRING);
    
    public CustomChestBoat(EntityType<? extends Boat> entityType, Level level) {
        super(entityType, level);
    }

    public CustomChestBoat(Level level, double x, double y, double z, ResourceLocation type) {
        this(ModEntityTypes.CUSTOM_CHEST_BOAT.get(), level);
    ...
    public Item getDropItem() {
        return this.getBoatType().getChestBoat();
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(BOAT_TYPE_ID, "minecraft:oak");
    }
