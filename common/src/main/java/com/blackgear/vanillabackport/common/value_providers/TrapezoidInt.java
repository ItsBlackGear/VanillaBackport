package com.blackgear.vanillabackport.common.value_providers;
...
public class TrapezoidInt extends IntProvider {
    public static final Codec<TrapezoidInt> CODEC = RecordCodecBuilder.<TrapezoidInt>create(instance -> instance.group(
