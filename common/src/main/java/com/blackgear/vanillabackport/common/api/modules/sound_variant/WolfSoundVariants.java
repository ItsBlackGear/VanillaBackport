...
public class WolfSoundVariants {
    public static final BuiltInCoreRegistry<WolfSoundVariant> REGISTRIES = BuiltInCoreRegistry.create(new ResourceLocation("wolf_sound_variants"), VanillaBackport.NAMESPACE);
