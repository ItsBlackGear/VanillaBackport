...
public class WolfSoundVariants {
    public static final BuiltInCoreRegistry<WolfSoundVariant> REGISTRIES = BuiltInCoreRegistry.create(ModRegistries.WOLF_SOUND_VARIANT.get(), VanillaBackport.NAMESPACE);
