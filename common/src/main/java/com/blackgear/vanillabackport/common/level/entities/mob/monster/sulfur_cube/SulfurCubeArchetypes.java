...
public class SulfurCubeArchetypes {
    public static final BuiltInCoreRegistry<SulfurCubeArchetype> REGISTRIES = BuiltInCoreRegistry.create(ResourceLocation.withDefaultNamespace("sulfur_cube_archetypes"), VanillaBackport.NAMESPACE);
