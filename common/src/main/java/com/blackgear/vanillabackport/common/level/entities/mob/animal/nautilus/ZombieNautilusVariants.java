...
public class ZombieNautilusVariants {
    public static final BuiltInCoreRegistry<ZombieNautilusVariant> REGISTRIES = BuiltInCoreRegistry.create(new ResourceLocation("zombie_nautilus_variants"), VanillaBackport.NAMESPACE);
