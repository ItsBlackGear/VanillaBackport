...
public final class BoatRegistry {
    public static final ResourceLocation DEFAULT_TYPE = new ResourceLocation("oak");
    ...
    public record BoatType(
        ...
        public BoatType(ResourceLocation id, Supplier<Item> boatItem, Supplier<Item> chestBoatItem, Supplier<Block> planksBlock, boolean isRaft) {
            this(
                ...
                planksBlock,
                isRaft,
                new ResourceLocation(id.getNamespace(), "textures/entity/boat/" + id.getPath() + ".png"),
                new ResourceLocation(id.getNamespace(), "textures/entity/chest_boat/" + id.getPath() + ".png")
            );
        }
