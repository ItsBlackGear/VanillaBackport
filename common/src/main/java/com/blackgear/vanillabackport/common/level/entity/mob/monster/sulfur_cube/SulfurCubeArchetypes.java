...
public class SulfurCubeArchetypes {
    public static final BuiltInCoreRegistry<SulfurCubeArchetype> REGISTRIES = BuiltInCoreRegistry.create(ModRegistries.SULFUR_CUBE_ARCHETYPE.get(), VanillaBackport.NAMESPACE);
