...
public class AbandonedCampStructurePools {
    ...
    private static void bootstrapTrees(BootstapContext<StructureTemplatePool> context, Holder<StructureTemplatePool> empty) {
    ...
    private static void registerTrees(BootstapContext<StructureTemplatePool> context, Holder<StructureTemplatePool> empty, Collection<Pair<String, ResourceKey<PlacedFeature>>> list) {
    ...
    private static void bootstrapCampsitePools(BootstapContext<StructureTemplatePool> context, Holder<StructureTemplatePool> empty) {
    ...
    private static void registerTentPool(BootstapContext<StructureTemplatePool> context, Holder<StructureTemplatePool> empty, AbandonedCampStructure biomeVariant) {
    ...
    private static void registerCampsitePool(BootstapContext<StructureTemplatePool> context, Holder<StructureTemplatePool> empty, AbandonedCampStructure biomeVariant) {
        ...
        Pools.register(
            context,
            biomeVariant.campStructureDirectory.location().getPath(),
